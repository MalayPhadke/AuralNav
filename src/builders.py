# """
# PyTorch-compatible builders for source separation architectures.
# This is a replacement for nussl.ml.networks.builders that uses direct PyTorch modules.
# """
...
def build_recurrent_chimera(num_features, hidden_size, num_layers, bidirectional,
                            ...
                            rnn_type='lstm', normalization_class='BatchNorm1d',
                            normalization_args=None, mix_key='mix_magnitude'):
    """
...
def build_recurrent_end_to_end(num_filters, filter_length, hop_length, window_type, 
                               ...
                               mix_key='mix_audio', normalization_class='BatchNorm1d',
