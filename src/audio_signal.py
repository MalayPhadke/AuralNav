...
class AudioSignal(object):
    ...
    **Sample Rate**
    ...
    def resample(self, new_sample_rate, **kwargs):
        ...
        for channel in self.get_channels():
            resampled_channel = librosa.resample(
                y=channel, orig_sr=self.sample_rate, target_sr=new_sample_rate, **kwargs)
    ...
    def get_channel(self, n):
        ...
        return np.asfortranarray(nussl_utils._get_axis(self.audio_data, constants.CHAN_INDEX, n))
    ...
    def get_stft_channel(self, n):
        ...
        return nussl_utils._get_axis(self.stft_data, constants.STFT_CHAN_INDEX, n)
    ...
    def get_power_spectrogram_channel(self, n):
        ...
        return nussl_utils._get_axis(np.array(self.power_spectrogram_data),
    ...
    def get_magnitude_spectrogram_channel(self, n):
        ...
        # np.array helps with duck typing
        return nussl_utils._get_axis(np.array(self.magnitude_spectrogram_data),
                               constants.STFT_CHAN_INDEX, n)
    ...
    def play(self):
        """
        Plays this audio signal, using `nussl.play_nussl_utils.play`.
    ...
    def _apply_user_ordered_effects(self):
        ...
        while i < len(self._effects_chain):
            ...
            if j == len(self._effects_chain) or \
                ...
                if isinstance(next_chain[0], nussl_effects.SoXFilter):
                    new_signal = nussl_effects.apply_effects_sox(new_signal, next_chain)
                elif isinstance(next_chain[0], nussl_effects.FFmpegFilter):
                    new_signal = nussl_effects.apply_effects_ffmpeg(new_signal, next_chain)
    ...
    def _apply_sox_ffmpeg_ordered_effects(self):
        ...
        for f in self._effects_chain:
            if isinstance(f, nussl_effects.FFmpegFilter):
                ffmpeg_effects_chain.append(f)
            elif isinstance(f, nussl_effects.SoXFilter):
                sox_effects_chain.append(f)

        if sox_effects_chain:
            new_signal = nussl_effects.apply_effects_sox(new_signal, sox_effects_chain)
        if ffmpeg_effects_chain:
            new_signal = nussl_effects.apply_effects_ffmpeg(new_signal, ffmpeg_effects_chain)
    ...
    def time_stretch(self, factor, **kwargs):
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.time_stretch(factor, **kwargs))
        return self
    ...
    def pitch_shift(self, n_semitones, **kwargs):
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.pitch_shift(n_semitones, **kwargs))
        return self
    ...
    def low_pass(self, freq, poles=2, width_type="h", width=0.707, **kwargs):
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.low_pass(freq, poles=poles,
    ...
    def high_pass(self, freq, poles=2, width_type="h", width=0.707, **kwargs):
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.high_pass(freq, poles=poles,
                                                     width_type=width_type,
                                                     width=width, **kwargs))
        return self
    ...
    def tremolo(self, mod_freq, mod_depth, **kwargs):
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.tremolo(mod_freq, mod_depth, **kwargs))
        return self
    ...
    def vibrato(self, mod_freq, mod_depth, **kwargs):
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.vibrato(mod_freq, mod_depth, **kwargs))
        return self
    ...
    def chorus(self, delays, decays, speeds,
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.chorus(delays, decays,
                                                  speeds, depths,
                                                  in_gain=in_gain,
                                                  out_gain=out_gain,
                                                  **kwargs))
    ...
    def phaser(self, in_gain=0.4, out_gain=0.74, delay=3, decay=0.4,
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        fx = nussl_effects.phaser(in_gain=in_gain, out_gain=out_gain, delay=delay,
    ...
    def flanger(self, delay=0, depth=2, regen=0, width=71, speed=0.5,
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        fx = nussl_effects.flanger(delay=delay, depth=depth, regen=regen, width=width,
    ...
    def emphasis(self, level_in, level_out, type_="col", mode='production', **kwargs):
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.emphasis(level_in, level_out,
    ...
    def compressor(self, level_in, mode="downward", reduction_ratio=2,
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        fx = nussl_effects.compressor(level_in, mode=mode, reduction_ratio=reduction_ratio,
    ...
    def equalizer(self, bands, **kwargs):
        ...
        See Also:
            ...
            * :func:`reset_effects_chain`: Empties the effects chain without applying any effects.
        """
        self._effects_chain.append(nussl_effects.equalizer(bands, **kwargs))
        return self
