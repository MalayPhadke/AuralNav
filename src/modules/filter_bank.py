...
class ISTFT(FilterBank):
    """
    Inverse Short-Time Fourier Transform using nn.Fold.
    """
    ...
    def forward(self, data, direction=None):
        return super().forward(data, direction='inverse')
